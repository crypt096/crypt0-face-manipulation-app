 ...
 * =============================================================================
 */
import { BackendTimingInfo, DataMover, DataType, KernelBackend, Rank, Scalar, ShapeMap, Tensor, Tensor1D, Tensor2D, Tensor3D, Tensor4D } from '@tensorflow/tfjs-core';
...
export declare class NodeJSKernelBackend extends KernelBackend {
    ...
    conv3d(x: Tensor<Rank.R5>, filter: Tensor<Rank.R5>, convInfo: Conv3DInfo): Tensor<Rank.R5>;
    conv3dDerInput(dy: Tensor<Rank.R5>, filter: Tensor<Rank.R5>, convInfo: Conv3DInfo): Tensor<Rank.R5>;
    conv3dDerFilter(x: Tensor<Rank.R5>, dY: Tensor<Rank.R5>, convInfo: Conv3DInfo): Tensor<Rank.R5>;
    ...
    sparseToDense<R extends Rank>(sparseIndices: Tensor<Rank>, sparseValues: Tensor<Rank>, outputShape: ShapeMap[R], defaultValue: Tensor<Rank.R0>): Tensor<R>;
